...
Процедура ВнешнееСобытиеОборудования(Форма, Источник, Событие, Данные) Экспорт
	...
	Если Результат = Неопределено Тогда 
		ТекстСообщения = НСтр("ru = 'При обработке внешнего события от устройства произошла ошибка:'; en = 'An error occurred while processing external event from the device:'")

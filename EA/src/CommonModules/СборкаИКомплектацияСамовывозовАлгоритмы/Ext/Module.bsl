...
Функция ЗарезервироватьТовар(СтруктураЗаказа) Экспорт
	...
	Попытка
		...
		Заказ.СтатусыОбработкиЗаказа = Справочники.СтатусыОбработкиЗаказа.ПереданНаСборку; 
		...
		СтатусыДокументов.УстановитьСтатусСборкиЗаказа(Заказ.Ссылка,Перечисления.ОснованияУстановкиСтатусаДокумента.HTTPСервисOrderReservation,Справочники.СтатусыОбработкиЗаказа.ЗаказСоздан);
		СтатусыДокументов.УстановитьСтатусАктуальностиЗаказа(Заказ.Ссылка,Перечисления.ОснованияУстановкиСтатусаДокумента.HTTPСервисOrderReservation,Справочники.СтатусыАктуальностиЗаказов.Актуален);
		ЗафиксироватьТранзакцию();

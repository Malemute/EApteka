...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если СтатусыДокументов.ПолучитьСтатусСборкиЗаказа(Ссылка) = Справочники.СтатусыОбработкиЗаказа.ЗаказВТочкеСамовывоза
		И Движения.ОтправкаСМС.Количество() = 0	И СтатусыДокументов.ПолучитьСтатусАктуальностиЗаказа(Ссылка) тогда
		...
		Движение.created = ПараметрыСеанса.ТекущийПользователь.Наименование;

...
//		ТабДвижений.Сортировать("ВидДвижения");
		Движения.Дефектура.Загрузить(ТабДвижений);
		
		Если Константы.ВестиРасчетыСПоставщиками.Получить() Тогда

			Движения.РасчетыСПоставщиками.Записывать = Истина;
			Движения.РасчетыСПоставщиками.Очистить();

			Движение = Движения.РасчетыСПоставщиками.Добавить();
			Движение.ВидДвижения = ВидДвиженияНакопления.Приход;
			Движение.Период = Дата;
			Движение.Поставщик = ЭтотОбъект.Клиент;
			Движение.ЗаказПоставщику = ЭтотОбъект.Ссылка;
			Движение.Сумма = ЭтотОбъект.Товары.Итог("Сумма");
